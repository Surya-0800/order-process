...
def split_pdf_custom(input_pdf, output_folder, final_output_dict, top_ratio=0.4):
    ...
    for page_num, page in enumerate(doc):
        ...
        if result_dict and result_dict.get("AWB")[0]:
            ...
            # --- Save the entire page without splitting ---
            full_page = new_doc.new_page(width=rect.width, height=rect.height)
            full_page.show_pdf_page(full_page.rect, doc, page_num)
