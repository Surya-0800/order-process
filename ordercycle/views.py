...
#             'meesho_processed': 0,
#             'skipped': 0,  # Track skipped entries
#             'errors': []
#         }
...
#                             # Check if this combination of order_number and SKU already exists
#                             sku_cleaned = item['sku'].replace("\n", "")
#                             if not FlipkarOrders.objects.filter(order_number=order_number, sku=sku_cleaned).exists():
...
#                             if not FirstcryOrders.objects.filter(order_number=order_number, sku=sku_cleaned).exists():
#                                 print(item)
...
#                             # Check if this combination of order_number and SKU already exists
#                             sku_cleaned = item['sku'].replace("\n", "")
#                             if not AmazonOrders.objects.filter(order_number=order_number, sku=sku_cleaned).exists():
...
#                             # Check if this combination of order_number and SKU already exists
#                             sku_cleaned = item['sku'].replace("\n", "")
#                             if not MeeshoOrders.objects.filter(order_number=order_number, sku=sku_cleaned).exists():
